    ...
    <body>
        <header>
                    ...
                    <div class="columns small-12 medium-6">
                        <nav class="float-right">
                            <ul class="vertical medium-horizontal menu text-center">
                                ...
                                <li><a href="#0"><i class="fi-list"></i> <span>Contact Us</span></a></li>
                            </ul>
                        <nav>
                    </div>
                </div>
            ...
            <div class="header__mast pad-tb-medium">
                ...
                <div class="row">
                    <div class="columns small-12 medium-12 pad-tb-2 pad-tb-small">
                        <nav class="header__main-nav">
                            <ul class="vertical medium-horizontal menu text-center">
                                <li class="columns shrink"><a href="#0"><i class="fi-list"></i> <span><i class="fa fa-home" aria-hidden="true"></i></span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>OUTDOOR FURNITURE</span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>OUTDOOR LOUNGES</span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>OUTDOOR DINING</span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>OUTDOOR BEDS</span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>OUTDOOR CHAIRS</span></a></li>
                                <li class="columns"><a href="#0"><i class="fi-list"></i> <span>ACCESORIES</span></a></li>
                            </ul>
                        <nav>
                    </div>
                </div>
