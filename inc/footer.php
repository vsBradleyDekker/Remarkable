    <footer class="footer__top">
        <div class="row">
            <div class="columns small-12 medium-3 large-3 footer__cat-items hide-for-small-only">
                ...
                <ul>
                    ...
                    <li><a href="#">Outdoor Bars</a></li>
                    <li><a href="#">Sunbeds &amp; Daybeds</a></li>
            ...
            <span class="footer__cat-title">Outdoor Lounges</span>
                <ul>
                    ...
                    <li><a href="#">Lounge Pieces</a></li>
                    <li><a href="#">Modular Lounges</a></li>
                    <li><a href="#">Corner Lounges</a></li>
        ...
        <div class="row footer__middle">
            ...
            <div class="columns small-12 medium-2 large-2 footer__middle_quicklinks  text-center hide-for-small-only">
                <span class="footer__middle__quicklinks__title">Quick Links</span>
                <ul class="footer__middle_menu">
                    <li><a href="#">Home</a></li>
                    <li><a href="#">About Us</a></li>
                    <li><a href="#">Delivery</a></li>
                    <li><a href="#">Visit Showroom</a></li>
                    <li><a href="#">Terms of Service</a></li>
                    <li><a href="#">Privacy Policy</a></li>
                    <li><a href="#">Contact Us</a></li>
                </ul>
            </div>
            <div class="columns small-12 medium-5 large-4 footer__middle_contact">
                <span class="footer__middle_contact__title">Contact Remarkable Furniture</span>
                <p><i class="fa fa-map-marker" aria-hidden="true"></i> 244 Chesterville Rd, Moorabbin VIC 3189 <p>
                <a href="#">Driving Directions</a>
                <p class="pad-t-small"><i class="fa fa-phone" aria-hidden="true"></i> 1300 296 505 </p>
                <p ><i class="fa fa-at" aria-hidden="true"></i><a href="#"> sales@remarkablefurniture.com.au</a></p>
                <p class="pad-t-small"><i class="fa fa-clock-o" aria-hidden="true"></i> Monday - Friday : 09:00am - 05:00pm </p>
                <p> Saturday - Sunday: 10.00am - 04:00pm </p>
            </div>
        </div>
