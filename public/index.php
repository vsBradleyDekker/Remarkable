<?php include('../inc/header.php') ?>
  <?php include('../inc/banner.php') ?>
    <section class="menu-grid">
      <div class="row pad-tb-medium">
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-1.jpg" alt="furniture">
          ...
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-2.jpg" alt="Lounges">
                <div class="card-section">
                <h3>Outdoor Lounges</h3>
                <p>+Show Sub Categories</p>
                <a href="#" class="button">SHOP NOW </a>
                </div>
            </div>
          ...
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-dining-1.jpg" alt="dining">
                <div class="card-section">
          ...
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-daybed-1.jpg" alt="daybeds">
              <div class="card-section">
              <h3>Outdoor Beds</h3>
                <p>+Show Sub Categories</p>
                <a href="#" class="button">SHOP NOW </a>
          ...
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-tables-1.jpg" alt="tables">
                <div class="card-section">
          ...
          <div class="columns small-12 medium-4">
            <div class="card">
              <img src="../img/outdoor-furniture-accessories-1.jpg" alt="accessories">
                <div class="card-section">
                <h3>Accessories</h3>
                <p>+Show Sub Categories</p>
                <a href="#" class="button">SHOP NOW </a>
